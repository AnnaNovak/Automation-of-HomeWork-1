...
# Создаем адреса
to_address = Address("123456", "Moscow", "Lenina", "10", "101")
from_address = Address("789456", "Saint Petersburg", "Nevsky", "22", "404")

# Создаем отправление
mailing = Mailing(to_address, from_address, 1000, "1234567890")
